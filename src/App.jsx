...
const Services = () => {
  ...
  return (
    <div id="leistungen" className="section-full sec" style={{background:'var(--stone)',position:'relative',overflow:'hidden'}}>
      ...
      <div style={{position:'absolute', inset:0, backgroundImage:"url('first.jpg')", backgroundSize:'cover', backgroundPosition:'center', opacity:0.04, pointerEvents:'none', zIndex:0}} />
...
const Steps = () => {
  ...
  return (
    <div id="ablauf" className="section-full sec" style={{background:'#fff',position:'relative',overflow:'hidden'}}>
      {/* ИЗОБРАЖЕНИЕ first.png НА ФОНЕ */}
      <div style={{position:'absolute', inset:0, backgroundImage:"url('first.jpg')", backgroundSize:'cover', backgroundPosition:'center', opacity:0.02, pointerEvents:'none', zIndex:0}} />
